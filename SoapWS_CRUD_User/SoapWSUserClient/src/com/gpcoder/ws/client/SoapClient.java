 ...
 * 
 * sau khi chạy câu lệnh trên ở terminal --> ra thư mục và copy các file .java bỏ vao package
 * 
 * Đây là cách gọi phương thức WS khi chỉ được cung cấp địa chỉ của file .wsdl
 */
